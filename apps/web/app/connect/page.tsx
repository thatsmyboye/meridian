 ...
 * Currently supports YouTube. Shows success/error feedback via query params
 * set by the OAuth callback routes.
 */

const ERROR_MESSAGES: Record<string, string> = {
  missing_params: "The OAuth response was incomplete. Please try again.",
  state_mismatch: "Security check failed. Please try again.",
  token_exchange_failed: "Could not complete authentication with Google. Please try again.",
  ...
  access_denied: "You cancelled the YouTube authorisation request.",
};
